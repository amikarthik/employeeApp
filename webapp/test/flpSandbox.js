		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee Data",
									"targetURL": "#employeefiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeefiori-display": {
								"semanticObject": "employeefiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employeefiori",
									"url": sap.ui.require.toUrl("employeefiori")
								}
							}
						}
					}
